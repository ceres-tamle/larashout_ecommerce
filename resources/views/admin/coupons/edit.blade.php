    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="tab-content">
                <form action="{{ route('admin.coupons.update') }}" method="POST" role="form">
                    @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('id') is-invalid @enderror" type="text"
                                                name="id" value="{{ old('id', $coupon->id) }}" readonly />
                                            <div class="invalid-feedback active">
                                                <i class="fa fa-exclamation-circle fa-fw"></i> @error('id')
                                                    <span>{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('time') is-invalid @enderror" type="text"
                                                name="time" value="{{ old('time', $coupon->time) }}" />
                                            <div class="invalid-feedback active">
                        ...
                        <div class="row d-print-none mt-2">
                            <div class="col-12 text-right">
                                <button class="btn btn-success" type="submit">
                                    <i class="fa fa-fw fa-lg fa-check-circle"></i>Save Coupon
                                </button>
